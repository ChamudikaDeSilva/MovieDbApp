...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2021 at 06:40 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `Myloop`()
begin
declare x int;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Myloop2`()
begin
declare x int;
declare msg varchar(50) default '';
set x = 0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `rloop`()
begin
declare x int;
...
INSERT INTO `comments` (`commentID`, `comments`, `Movie_id`, `commentby`, `commentedon`) VALUES
(1, 'Good Crime Thriller', 'MoDT001', 'Piraba', '2019-02-25 04:18:36'),
(2, 'Liam Neeson fabulous act', 'MoDT001', 'James', '2019-02-01 17:31:24'),
(3, 'my point 7/10', 'MoDT001', 'Jenifer', '2019-02-25 10:48:13'),
(4, 'check', 'MoDT001', 'Jenifer', '2019-02-25 10:48:57'),
(5, 'check', 'MoDT001', 'Jenifer', '2019-02-25 10:50:09'),
(6, 'maze solved', 'MoDT003', 'Jenifer', '2019-02-25 10:51:56');
...
CREATE TABLE IF NOT EXISTS `moviedetails` (
  ...
  `story_Line` varchar(4000) DEFAULT NULL,
  `coverimage` varchar(12) DEFAULT NULL,
...
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`Movie_id`) REFERENCES `moviedetails` (`Movie_id`),
  ADD CONSTRAINT `comments_ibfk_3` FOREIGN KEY (`commentby`) REFERENCES `login` (`username`);
